    ...
    public class ClienteController : Controller
    {
        ...
        public JsonResult Incluir(ClienteModel model)
        {
            ...
            else
            {
                ...
                var cpfValido = ValidaCPF.ValidaCpf(model.CPF);
                ...
                {
                    Response.StatusCode = 400;
                    return Json("Já existe esse CPF cadastrado!");
                }
                ...
                if (model.Beneficiario != null && model.Beneficiario.CPF != null && model.Beneficiario.CPF != "")
                {
